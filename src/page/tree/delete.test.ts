...
describe("page/tree/delete", () => {
  ...
  describe("delete content", () => {
    ...
    test("Scenario 1c: delete from a point in a node to the end of the node (test 4)", () => {
      const page: PageContent = {
        buffers: [
          {
            content: "abc\ndzef",
    ...
    test("Scenario 1c: delete from the start of a node to a point in the node (test 5)", () => {
      const page: PageContent = {
        buffers: [
          {
            content: "abc\ndef",
