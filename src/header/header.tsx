...
const sampleTextHtml =
  ...
  `<p id="p:{6cb59116-8e61-03a9-39ef-edf64004790d}{62}" ` +
  ...
  `</p>` +
  `<p id="p:{a977e62e-3126-8e0d-1368-bcf55df0a6de}{15}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `<span ` +
  ...
  `</span>` +
  `</p>` +
  `<p id="p:{ee695e3a-1d4a-0a68-043f-8be19ed60633}{11}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `<span style="font-weight:bold;text-decoration:underline">` +
  `No italics but bold and underlined</span>` +
  `</p>` +
  `<p id="p:{044b9964-f242-02d2-3bb2-4b6e0d569c68}{11}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `Nothing but ` +
  ...
  `Quote` +
  `</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{21}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">Normal</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{23}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `<span style="background-color:yellow">Highlighted</span>` +
  `</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{26}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `<span style="color:red">Red text</span>` +
  `</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{29}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `Superscript x<sup>2</sup>` +
  `</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{32}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `Subscript x<sub>2</sub>` +
  `</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{35}" ` +
  `style="margin-top:0pt;margin-bottom:0pt">` +
  `<span style="text-decoration:line-through">Crossed out</span>` +
  `</p>` +
  `<p id="p:{28216e73-1f0a-05fd-25c5-a04844147e70}{38}" ` +
