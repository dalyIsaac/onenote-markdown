...
export const paragraphTagsHtmlContent =
  `<html lang="en-NZ">
          <head>
...
export const paragraphTagsHtmlExpectedPage: PageContent = {
  buffers: [
    {
...
Newline.`,
  ...
  test("Paragraph tags with formatting", () => {
    const page = new Parser(paragraphTagsHtmlContent).parse();
    expect(page).toEqual(paragraphTagsHtmlExpectedPage);
  });
...
            			<p id="p:{6cb59116-8e61-03a9-39ef-edf64004790d}{130}" style="margin-top:0pt;` +
    ...
    const expectedPage: PageContent = {
      ...
      previouslyInsertedNodeOffset: 13,
      root: 2,
      title: "This is the title",
    };
    expect(page).toEqual(expectedPage);
  ...
  test("Quotes (charRef)", () => {
    const html =
      `<html lang="en-NZ">
                ...
                <body data-absolute-enabled="true" style="font-family:Calibri;font-size:11pt">
            			<p id="p:{6cb59116-8e61-03a9-39ef-edf64004790d}{130}" style="margin-top:0pt;` +
      `margin-bottom:0pt">  <span style="font-weight:bold"
    ...
    const expectedPage: PageContent = {
      ...
      previouslyInsertedNodeIndex: 4,
      previouslyInsertedNodeOffset: 27,
      root: 2,
      title: "This is the title",
    };
  });
